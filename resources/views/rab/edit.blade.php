        ...
        <form action="{{ route('rab.update', $rab) }}" method="POST" id="rabForm" class="space-y-6">
                ...
                <div class="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="{{ old('waktu_mulai', $rab->waktu_mulai) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="waktu_selesai"
                            class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent"
                            value="{{ old('waktu_selesai', $rab->waktu_selesai) }}">
                    </div>
                        ...
                        <tbody id="rabTableBody">
                            @forelse($rab->items as $index => $item)
                                <tr class="rab-item-row" data-row="{{ $index }}">
                                    ...
                                    <td class="border border-gray-300 px-2 py-2">
                                        <input type="number" name="items[{{ $index }}][potongan_50_persen]" class="w-full px-1 py-1 border border-gray-300 rounded text-xs text-right potongan-input" placeholder="0" step="0.01" value="{{ $item->potongan_50_persen }}">
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2">
                                        <input type="number" name="items[{{ $index }}][pajak]" class="w-full px-1 py-1 border border-gray-300 rounded text-xs text-right pajak-input" placeholder="0" step="0.01" value="{{ $item->pajak }}">
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2">
                                        <input type="number" name="items[{{ $index }}][jumlah_pasca_pajak]" class="w-full px-1 py-1 border border-gray-300 rounded text-xs text-right bg-yellow-50 pasca-pajak-input" placeholder="0" value="{{ $item->jumlah_pasca_pajak }}" readonly>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][surat_undangan]" class="surat-checkbox" value="1" {{ $item->surat_undangan ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][kak]" class="kak-checkbox" value="1" {{ $item->kak ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][materi]" class="materi-checkbox" value="1" {{ $item->materi ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][notulen]" class="notulen-checkbox" value="1" {{ $item->notulen ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][absen]" class="absen-checkbox" value="1" {{ $item->absen ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                                        <input type="checkbox" name="items[{{ $index }}][kuitansi]" class="kuitansi-checkbox" value="1" {{ $item->kuitansi ? 'checked' : '' }}>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
            ...
            <div class="flex gap-3">
                <button type="submit" class="flex-1 bg-gradient-to-r from-[#3b82f6] to-[#1e3a8a] hover:from-[#1e3a8a] hover:to-[#0f172a] text-white font-bold py-3 rounded-lg transition transform hover:scale-105">
                    <i class="fas fa-save"></i> Perbarui RAB
                </button>
